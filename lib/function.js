...
const uploadImages = (buffData, type) => {
    return new Promise(async (resolve, reject) => {
        ...
        const filePath = 'trash/sampah.' + ext
...
module.exports = { wait, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, close, uploadImages }
